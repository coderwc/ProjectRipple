...
const DonorProfile = ({ onBack, onLogout }) => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      console.log("✅ Donor profile image upload successful:", uploadResult);
      ...
      console.log("✅ Donor profile image updated successfully");

    } catch (error) {
      console.error("❌ Error uploading donor profile image:", error);
  ...
  return (
    <div className="max-w-sm mx-auto min-h-screen bg-gradient-to-b from-blue-200 via-blue-100 to-white relative">
      ...
      {/* Header */}
      <div className="bg-white px-4 py-4 border-b border-gray-200 shadow-md">
        ...
        <p className="text-sm text-gray-500 mt-2 ml-12">Manage account</p>
      </div>
      ...
      <div className="flex justify-center mb-4 relative">
        <label htmlFor="profileImageUpload" className="cursor-pointer group">
          <div className="relative">
            <div className={`w-24 h-24 bg-blue-100 rounded-full flex items-center justify-center border-4 border-white -mt-6 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 ${imageUploading ? 'pointer-events-none' : ''}`}>
      ...
      <div className="px-4 py-6 space-y-4 pb-24">
        ...
        {/* Member Since */}
        <div className="bg-white border border-blue-200 rounded-xl shadow p-4">
          <h3 className="text-md font-semibold text-gray-900 mb-2">Member Since</h3>
